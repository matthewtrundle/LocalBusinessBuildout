...
export default function pinthousePage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-yellow-900 via-amber-900 to-black">

      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <motion.div
          style={{ y }}
          className="absolute inset-0 bg-gradient-to-br from-yellow-900 to-amber-900"
        >
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-yellow-200 mb-12 italic"
          >
          ...
          >
            <button className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold text-lg px-12 py-4 rounded-full magnetic-btn shadow-2xl">
              Visit Us
            </button>
          ...
          >
            <p className="text-yellow-200 uppercase text-xs mb-1 tracking-wider">Location</p>
      ...
      <section className="py-24 px-6 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-6xl font-bold text-center mb-16 gradient-text from-yellow-400 to-white font-serif"
          >
            On Tap
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-yellow-200">Premium quality and exceptional service in every detail.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 bg-gradient-to-br from-yellow-900 via-amber-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-6 justify-center"
          >
            <button className="bg-white text-yellow-900 font-bold text-lg px-12 py-4 rounded-full hover:bg-yellow-50 transition-all duration-300 magnetic-btn shadow-2xl">
              Get Directions
            </button>
