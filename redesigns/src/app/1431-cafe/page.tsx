...
export default function FM1431CafePage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-teal-900 via-cyan-900 to-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <div className="absolute bottom-20 right-20 w-72 h-72 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        </motion.div>
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-cyan-200 mb-12 italic"
          >
          ...
          >
            <button className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white font-bold text-lg px-12 py-4 rounded-full magnetic-btn shadow-2xl">
              Visit Us
            </button>
          ...
          >
            <p className="text-cyan-200 uppercase text-xs mb-1 tracking-wider">Location</p>
            <p className="text-white font-semibold">601 E Whitestone Blvd, Suite 300, Cedar Park, TX</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-6xl font-bold text-center mb-16 gradient-text from-cyan-400 to-white font-serif"
          >
            What We Serve
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-cyan-200">Premium quality and exceptional service in every detail.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 bg-gradient-to-br from-teal-900 via-cyan-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            601 E Whitestone Blvd, Suite 300, Cedar Park, TX
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-6 justify-center"
          >
            <button className="bg-white text-teal-900 font-bold text-lg px-12 py-4 rounded-full hover:bg-cyan-50 transition-all duration-300 magnetic-btn shadow-2xl">
              Get Directions
            </button>
