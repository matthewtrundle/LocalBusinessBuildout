...
export default function derricksbarbershopPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-indigo-200 mb-12 italic"
          >
          ...
          >
            <button className="bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-bold text-lg px-12 py-4 rounded-full magnetic-btn shadow-2xl">
              Book Now
            </button>
          ...
          >
            <p className="text-indigo-200 uppercase text-xs mb-1 tracking-wider">Location</p>
      ...
      <section className="py-24 px-6 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-6xl font-bold text-center mb-16 gradient-text from-indigo-400 to-white font-serif"
          >
            Our Services
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-indigo-200">Premium quality and exceptional service in every detail.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 bg-gradient-to-br from-indigo-900 via-purple-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-6 justify-center"
          >
            <button className="bg-white text-indigo-900 font-bold text-lg px-12 py-4 rounded-full hover:bg-indigo-50 transition-all duration-300 magnetic-btn shadow-2xl">
              Get Directions
            </button>
