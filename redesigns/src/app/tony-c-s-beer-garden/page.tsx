...
export default function tonycsbeergardenPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-orange-900 via-red-900 to-black">

      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <motion.div
          style={{ y }}
          className="absolute inset-0 bg-gradient-to-br from-orange-900 to-red-900"
        >
          ...
          <div className="absolute bottom-20 right-20 w-72 h-72 bg-orange-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        </motion.div>
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-orange-200 mb-12 italic"
          >
            Austin's Favorite Beer Garden
          </motion.p>
          ...
          >
            <button className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold text-lg px-12 py-4 rounded-full magnetic-btn shadow-2xl">
              Visit Us
            </button>
          ...
          >
            <p className="text-orange-200 uppercase text-xs mb-1 tracking-wider">Location</p>
      ...
      <section className="py-24 px-6 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-6xl font-bold text-center mb-16 gradient-text from-orange-400 to-white font-serif"
          >
            On Tap
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-orange-200">Premium quality and exceptional service in every detail.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 bg-gradient-to-br from-orange-900 via-red-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl text-orange-200 mb-10"
          >
            Austin, TX
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-6 justify-center"
          >
            <button className="bg-white text-orange-900 font-bold text-lg px-12 py-4 rounded-full hover:bg-orange-50 transition-all duration-300 magnetic-btn shadow-2xl">
              Get Directions
            </button>
