...
export default function dannysbarbershopPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-red-900 via-gray-900 to-black">

      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <motion.div
          style={{ y }}
          className="absolute inset-0 bg-gradient-to-br from-red-900 to-gray-900"
        >
          ...
          <div className="absolute bottom-20 right-20 w-72 h-72 bg-red-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        </motion.div>
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-red-200 mb-12 italic"
          >
            Traditional Barbering Excellence
          </motion.p>
          ...
          >
            <button className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold text-lg px-12 py-4 rounded-full magnetic-btn shadow-2xl">
              Book Now
            </button>
          ...
          >
            <p className="text-red-200 uppercase text-xs mb-1 tracking-wider">Location</p>
            <p className="text-white font-semibold">2301 S. Lakeline Blvd., Ste. 400, Cedar Park, TX</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-6xl font-bold text-center mb-16 gradient-text from-red-400 to-white font-serif"
          >
            Our Services
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-red-200">Premium quality and exceptional service in every detail.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 bg-gradient-to-br from-red-900 via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl text-red-200 mb-10"
          >
            2301 S. Lakeline Blvd., Ste. 400, Cedar Park, TX
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-6 justify-center"
          >
            <button className="bg-white text-red-900 font-bold text-lg px-12 py-4 rounded-full hover:bg-red-50 transition-all duration-300 magnetic-btn shadow-2xl">
              Get Directions
            </button>
